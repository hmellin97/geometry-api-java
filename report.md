...
* Mathieu : [`Line::_intersectLineLine`](https://github.com/hmellin97/geometry-api-java/blob/mathieu-diy/src/main/java/com/esri/core/geometry/Line.java) and [`SegmentIntersecot::intersect`](https://github.com/hmellin97/geometry-api-java/blob/mathieu-diy/src/main/java/com/esri/core/geometry/SegmentIntersector.java) and the [`TestLine`](https://github.com/hmellin97/geometry-api-java/blob/mathieu-test/src/test/java/com/esri/core/geometry/TestLine.java) and [`TestSegmentIntersector`](https://github.com/hmellin97/geometry-api-java/blob/mathieu-test/src/test/java/com/esri/core/geometry/TestSegmentIntersector.java)
* My : [`PolygonUtils::testPointsOnPolyLine2D_`](https://github.com/hmellin97/geometry-api-java/blob/My-test/src/main/java/com/esri/core/geometry/PolygonUtils.java) and [`Envelope2D::clipLine`](https://github.com/hmellin97/geometry-api-java/blob/My-test/src/main/java/com/esri/core/geometry/Envelope2D.java) and [`TestEnvolope2D`](https://github.com/hmellin97/geometry-api-java/blob/My-test/src/test/java/com/esri/core/geometry/TestEnvelope2D.java) and [`TestIntersection`](https://github.com/hmellin97/geometry-api-java/blob/My-test/src/test/java/com/esri/core/geometry/TestIntersection.java) for the `PoligonUtils` class.
...
* Axel : [`WktParser::attributes_`](https://github.com/hmellin97/geometry-api-java/blob/Axel-test/src/main/java/com/esri/core/geometry/WktParser.java) and [`RelationalOperations::polygonTouchesPolygonImpl_`](https://github.com/hmellin97/geometry-api-java/blob/Axel-test/src/main/java/com/esri/core/geometry/RelationalOperations.java)
...
* Mathieu : -
* My : -
* Julian : [`Envelope2D::_boundaryDistance`](https://github.com/hmellin97/geometry-api-java/blob/Julian-test/src/main/java/com/esri/core/geometry/Envelope2D.java) and [`Envelope2D::merge`](https://github.com/hmellin97/geometry-api-java/blob/Julian-test/src/main/java/com/esri/core/geometry/Envelope2D.java) and the [`TestEnvolope2D`](https://github.com/hmellin97/geometry-api-java/blob/Julian-test/src/test/java/com/esri/core/geometry/TestEnvelope2D.java)
* Axel : `Boundary::hasNonEmptyBoundary` and the [TestBoundary](https://github.com/hmellin97/geometry-api-java/blob/Axel-test/src/test/java/com/esri/core/geometry/TestBoundary.java) 
* Henrik : [`Envelope3D::intersect`](https://github.com/hmellin97/geometry-api-java/blob/henrik-test/src/main/java/com/esri/core/geometry/Envelope3D.java) and [`Envelope2D::_snapToBoundary`](https://github.com/hmellin97/geometry-api-java/blob/henrik-test/src/main/java/com/esri/core/geometry/Envelope2D.java) and the [`TestEnvolope`](https://github.com/hmellin97/geometry-api-java/blob/Julian-test/src/test/java/com/esri/core/geometry/TestEnvelope.java)
